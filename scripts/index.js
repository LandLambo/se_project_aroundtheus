...
// preview Image
const previewImageModal = document.querySelector("#js-preview-popup");
const previewImageElement = document.querySelector(".preview__Image-Modal");
...
previewPopUpCloseButton.addEventListener("click", closePopup);
